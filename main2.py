...
t, v = simulate_cruise(Kp=1360, Ki=300, Kd=0, label='PI-Control')
plt.plot(t, v, label='PI (Kp=1360, Ki=100): Corrects speed bias')

# Test 3: PID Control (Exercise 11/12) Kd = 100 BEST
t, v = simulate_cruise(Kp=1360, Ki=200, Kd=100, label='PID-Control')
plt.plot(t, v, label='PID (Kp=1360, Ki=200, Kd=100): Smoother recovery')
